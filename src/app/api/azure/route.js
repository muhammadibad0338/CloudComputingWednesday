...
export async function PUT(req) {
    try {
        ...
        const azureRegionCountries = [
            ...
            { code: "uaecentral", countryName: "United Arab Emirates" },
            { code: "uaenorth", countryName: "United Arab Emirates" },
            { code: "uksouth", countryName: "United Kingdom" },
            { code: "ukwest", countryName: "United Kingdom" },
